...
use crate::email::{Attachment, Body, Header, Recipients, SingleEmailData};
...
impl From<SingleEmailData> for PostmarkEmailRequest {
    fn from(email: SingleEmailData) -> Self {
        Self {
            from: email.r#from,
...
mod tests {
    ...
    fn minimal_email(body: Body) -> SingleEmailData {
        SingleEmailData {
